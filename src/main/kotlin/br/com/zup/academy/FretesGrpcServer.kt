...
@Singleton
class FretesGrpcServer : GrpcFretesServiceGrpc.GrpcFretesServiceImplBase() {
    ...
    override fun calculaFrete(request: CalculaFreteRequest?, responseObserver: StreamObserver<CalculaFreteResponse>?) {
        ...
        // Simulando erro de verificação de segurança
        if (cep.endsWith("333")) {
        ...
        try {
            valor = Random.nextDouble(from = 10.0, until = 140.0)
            if (valor > 100.0) {
